...
class GS_LR_Schedulers:
    means: Optional[torch.optim.lr_scheduler.LRScheduler] | bool = True
    scales: Optional[torch.optim.lr_scheduler.LRScheduler] | bool = False
    quats: Optional[torch.optim.lr_scheduler.LRScheduler] | bool = False
    opacities: Optional[torch.optim.lr_scheduler.LRScheduler] | bool = False
    features_dc: Optional[torch.optim.lr_scheduler.LRScheduler] | bool = False
    features_rest: Optional[torch.optim.lr_scheduler.LRScheduler] | bool = False
    features_semantics: Optional[torch.optim.lr_scheduler.LRScheduler] | bool = False

    def all_schedulers(self) -> Iterator[Tuple[str, "torch.optim.lr_scheduler.LRScheduler"]]:
        """Iterate over all active geometric schedulers.
