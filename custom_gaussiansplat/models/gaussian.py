...
class GaussianModel(BaseTrainableModel):
    ...
    def get_render_params(self, cam, sh_cfg, is_training: bool = True, lod: Optional[int] = None) -> RenderParams:
        """Return rasterization-ready tensors for this view.

        Returns a RenderParams dataclass with the parameters needed for rasterization.
        """
